...
-Billing management (Generate invoices and save them to a folder, allowing for organized archiving). When submitting an invoice, text file will be saved to the user's documents folder)<br>
